...
There are installation instructions for [Ubuntu](./INSTALL_Ubuntu.md), MAC and Windows. For MAC and Ubuntu, you will use a Docker virtual environment. Windows will use WSL (Windows Subsytem for Linux). See
